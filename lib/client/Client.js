...
class Client extends EventEmitter {
     ...
     * @param {Array} [options.intents=['GUILDS', 'GUILD_MESSAGES']] The list of intent groups you want to receive. See here for the intent group names and what events you receive: https://discordapp.com/developers/docs/topics/gateway#list-of-intents
