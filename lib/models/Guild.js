...
const { channelTypes, permissions } = require('../util/Constants');
...
const PermissionsHandler = require('../util/PermissionsHandler');
...
class Guild {
    ...
    constructor(client, obj, user = undefined) {
        ...
        for (const member of obj.members) {
            ...
            this.members.set(member.user.id, new Member(client, member, user));
        }
