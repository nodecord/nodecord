...
const permissions = {
    CREATE_INSTANT_INVITE: { hex: 0x00000001, twofactor: false, overrides: [], channelTypes: [channelTypes.TEXT, channelTypes.VOICE] },
    ...
    MANAGE_CHANNELS: { hex: 0x00000010, twofactor: true, overrides: [], channelTypes: [channelTypes.TEXT, channelTypes.VOICE] },
    MANAGE_GUILD: { hex: 0x00000020, twofactor: true, overrides: [], channelTypes: [] },
    ADD_REACTIONS: { hex: 0x00000040, twofactor: false, overrides: [], channelTypes: [channelTypes.TEXT] },
    VIEW_AUDIT_LOG: { hex: 0x00000080, twofactor: false, overrides: [], channelTypes: [] },
    PRIORITY_SPEAKER: { hex: 0x00000100, twofactor: false, overrides: [], channelTypes: [channelTypes.VOICE] },
    STREAM: { hex: 0x00000200, twofactor: false, overrides: [], channelTypes: [channelTypes.VOICE] },
    VIEW_CHANNEL: { hex: 0x00000400, twofactor: false, overrides: [], channelTypes: [channelTypes.TEXT, channelTypes.VOICE] },
    SEND_MESSAGES: { hex: 0x00000800, twofactor: false, overrides: [], channelTypes: [channelTypes.TEXT] },
    SEND_TTS_MESSAGES: { hex: 0x00001000, twofactor: false, overrides: [], channelTypes: [channelTypes.TEXT] },
    MANAGE_MESSAGES: { hex: 0x00002000, twofactor: true, overrides: [], channelTypes: [channelTypes.TEXT] },
    EMBED_LINKS: { hex: 0x00004000, twofactor: false, overrides: [], channelTypes: [channelTypes.TEXT] },
    ATTACH_FILES: { hex: 0x00008000, twofactor: false, overrides: [], channelTypes: [channelTypes.TEXT] },
    READ_MESSAGE_HISTORY: { hex: 0x00010000, twofactor: false, overrides: [], channelTypes: [channelTypes.TEXT] },
    MENTION_EVERYONE: { hex: 0x00020000, twofactor: false, overrides: [], channelTypes: [channelTypes.TEXT] },
    USE_EXTERNAL_EMOJIS: { hex: 0x00040000, twofactor: false, overrides: [], channelTypes: [channelTypes.TEXT] },
    VIEW_GUILD_INSIGHTS	: { hex: 0x00080000, twofactor: false, overrides: [], channelTypes: [] },
    CONNECT: { hex: 0x00100000, twofactor: false, overrides: [], channelTypes: [channelTypes.VOICE] },
    SPEAK: { hex: 0x00200000, twofactor: false, overrides: [], channelTypes: [channelTypes.VOICE] },
    MUTE_MEMBERS: { hex: 0x00400000, twofactor: false, overrides: [], channelTypes: [channelTypes.VOICE] },
    DEAFEN_MEMBERS: { hex: 0x00800000, twofactor: false, overrides: [], channelTypes: [channelTypes.VOICE] },
    MOVE_MEMBERS: { hex: 0x01000000, twofactor: false, overrides: [], channelTypes: [channelTypes.VOICE] },
    USE_VAD: { hex: 0x02000000, twofactor: false, overrides: [], channelTypes: [channelTypes.VOICE] },
    ...
    MANAGE_ROLES: { hex: 0x10000000, twofactor: true, overrides: [], channelTypes: [channelTypes.TEXT, channelTypes.VOICE] },
    MANAGE_WEBHOOKS: { hex: 0x20000000, twofactor: true, overrides: [], channelTypes: [channelTypes.TEXT, channelTypes.VOICE] },
